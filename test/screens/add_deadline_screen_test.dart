...
void main() {
  group('AddDeadlineScreen Widget Tests', () {
    ...
    testWidgets('shows title input field', (tester) async {
      ...
      expect(find.widgetWithText(TextFormField, 'Enter deadline title'), findsOneWidget);
    ...
    testWidgets('shows description input field', (tester) async {
      ...
      expect(find.widgetWithText(TextFormField, 'Enter deadline description'), findsOneWidget);
    ...
    testWidgets('shows save button', (tester) async {
      ...
      expect(find.widgetWithText(ElevatedButton, 'Save Deadline'), findsOneWidget);
    });
    ...
    testWidgets('saves deadline with correct timestamp', (tester) async {
      ...
      expect(deadline.createdAt.isAfter(beforeTime.subtract(const Duration(seconds: 1))), true);
      expect(deadline.createdAt.isBefore(afterTime.add(const Duration(seconds: 1))), true);
    });
