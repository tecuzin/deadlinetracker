...
void main() {
  group('App Integration Tests', () {
    testWidgets('Complete flow: Add deadline -> View in list -> Delete', (tester) async {
    ...
    testWidgets('Navigation between Deadlines and Statistics tabs', (tester) async {
      await tester.pumpWidget(const MyApp());
    ...
    testWidgets('Cancel deletion dialog returns to list without deleting', (tester) async {
      await tester.pumpWidget(const MyApp());
